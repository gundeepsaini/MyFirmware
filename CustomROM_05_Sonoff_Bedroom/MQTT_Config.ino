...
// Light
#define MQTT_TOPIC_STATE_LIGHT "HA/Custom04_Sonoff02_Bedroom/state" 
#define MQTT_TOPIC_CMD_LIGHT   "HA/Custom04_Sonoff02_Bedroom/cmd"  

// Will Topic - Availability
#define MQTT_TOPIC_WILL        "HA/Custom04_Sonoff02_Bedroom/status"     
