...
void Prep_webpage1()
{
  ...
  String body_table_start = String("<h2>") + DeviceHostName + String("</h2><h4>Updated time: ") + timeStr + String("</h4><table>");
  ...
  String body_table_row01 =String("<tr><td>01</td><td>Motion State</td><td>")        + String(MotionState)     + String("</td><td>-</td></tr>");
  String body_table_row02 =String("<tr><td>02</td><td>HA Motion Control</td><td>")   + String(Motion_Control)  + String("</td><td>-</td></tr>");
  String body_table_row03 =String("<tr><td>03</td><td>Relay State</td><td>")         + String(RelayState)      + String("</td><td>-</td></tr>");  
