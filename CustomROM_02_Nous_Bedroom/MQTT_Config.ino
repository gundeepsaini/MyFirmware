...
// Light
#define MQTT_TOPIC_STATE       "HA/Custom02_Nous01_Bedroom/state" 
#define MQTT_TOPIC_CMD         "HA/Custom02_Nous01_Bedroom/cmd"  

// Will Topic - Availability
#define MQTT_TOPIC_WILL        "HA/Custom02_Nous01_Bedroom/status"     
